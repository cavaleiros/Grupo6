                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <form action="controller.do" method="post">
                                ...
                                <button type="submit" class="btn btn-primary" name="command" value="ManterClienteExcluir">Sim</button>
            ...
            <div id="main" class="container-fluid">
                ...
                <button class="btn btn-primary" type="submit" name="command" value="ListarClientesBuscar">
                    <span class="glyphicon glyphicon-search"></span>
                        ...
                        <div class="col-md-3">
                            <a href="controller.do?command=CriarCliente" class="btn btn-primary pull-right h2">Novo Cliente</a>
                        </div>
                    </div>
                    <!-- /#top -->
                </form>
                            ...
                            <tbody>
          					<c:forEach var="cliente" items="${lista }">
                                       <tr>
                                            ...
                                            <td class="actions">
                                                <a class="btn btn-success btn-xs" href="controller.do?command=ManterClienteVisualizar&id=${cliente.id }">Visualizar</a>
                                                <a class="btn btn-warning btn-xs" href="controller.do?command=ManterClienteEditar&id=${cliente.id }">Editar</a>
