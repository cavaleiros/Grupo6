	...
	<div class="full">
		...
		<div class="single-content">
			...
			<div class="reviews-section">
				<h3 class="head">Informações sobre o filme</h3>
					<div class="col-md-9 reviews-grids">
						<div class="review">
							...
							<div class="review-info">
								...
								<p class="ratingview c-rating">Avaliação dos clientes:</p>
								<div class="rating">
									<span>☆</span>
									<span>☆</span>
									<span>☆</span>
								...
								<div class="yrw">
									<div class="dropdown-button">           			
										...
										<option value="0">Avalie</option>	
										<option value="1">1.Péssimo</option>
										<option value="2">1.5(Ruim)</option>
										<option value="3">2.Regular</option>
										<option value="4">2.5(Médio)</option>
										<option value="5">3.Assistivel</option>
										<option value="6">3.5(Bom)</option>
										<option value="7">4.5(Muito Bom)</option>
										<option value="8">5.Espetacular!</option>
									  </select>
									</div>
								...
								<p class="info">Atores: Will Smith, Margot Robbie, Adrian Martinez, Rodrigo Santoro, BD Wong, Robert Taylor</p>
								<p class="info">Direção:  Ficarra, John Requa</p>
								<p class="info">Genêro: Crime</p>
								<p class="info">Duração: 1 hora 45 minutos</p>
							</div>
							<div class="clearfix"></div>
						</div>
